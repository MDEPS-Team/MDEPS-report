...
| --- | --- |
| ![foto-angiela](assets/images/chapter-1/profiles/Angiela.jpeg) | **Fuentes Alvarez, Angiela Stephany**<br> **Codigo: U202520331** \| **Carrera: Ingenieria de Software**<br>*Resumen:* Estudiante de Ingeniería de Software con interés en el análisis de requerimientos, experiencia de usuario y desarrollo de soluciones tecnológicas. En el equipo participo en el proceso de Needfinding, realizando entrevistas, organizando y analizando la información recopilada y desarrollando artefactos como User Personas, User Journey Mapping y Empathy Mapping. Me caracterizo por ser una persona organizada, responsable y con disposición para aprender nuevas herramientas y conocimientos, además de aportar al trabajo colaborativo y la comunicación dentro del equipo. |
...
| ![foto-lionel](assets/images/chapter-1/profiles/lionel.jpeg) | **Mendoza Machoa, Lionel Snayder**<br> **Codigo: u202417433** \| **Carrera: Ingenieria de Software**<br>*Resumen:* Con conocimientos en C++, Python, HTML, CSS y JavaScript, con enfoque en trabajo colaborativo y desarrollo de software orientado a objetos. Aporta al equipo habilidades en diseño de requisitos y especificación de funcionalidades. |
